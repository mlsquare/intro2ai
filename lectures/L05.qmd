...
- [Classification](L02.qmd)

### In-Class

- History of Deep Learning
    -   Lecture-1 [pdf](http://www.cse.iitm.ac.in/~miteshk/CS7015/Slides/Handout/Lecture1.pdf), [Interactive slides](https://iitm-pod.slides.com/arunprakash_ai/lecture-1-briefhistoryofdl/fullscreen)
    -   Lecture-1 [pdf](https://www.shane.st/teaching/574/spr24/slides/1_Intro.pdf) 
- Visualizations
    -   [Interactive Figures](https://udlbook.github.io/udlfigures/) to visualize NNs 
    -   [Representational Power of NNs](http://neuralnetworksanddeeplearning.com/chap4.html)

### Lab

- [Perceptron for Classification](./../notebooks/05-01-Perceptron-Class-Iris.ipynb) on Iris data

### Post-class


- Neural Networks Motivation
    -   McCulloch-Pitts Neuron, Perceptron [Lecture-2:pdf](http://www.cse.iitm.ac.in/~miteshk/CS7015/Slides/Handout/Lecture2.pdf) 
    -   Digital Logic Modeling by Perceptron [Neural Networks:pdf](https://www.shane.st/teaching/574/spr24/slides/4_NN.pdf)
- FFNs
    -   [FFNs for Classification and Language Modeling: pdf](https://www.shane.st/teaching/574/spr24/slides/6_FF-class-lm.pdf)

### Advanced

1.  [Lecture-3:pdf](http://www.cse.iitm.ac.in/~miteshk/CS7015/Slides/Handout/Lecture3.pdf) Sigmoid Neuron, Error Surfaces, Representation Power of FFNs
2.  [Gradient Descent, Word Vectors](https://www.shane.st/teaching/574/spr24/slides/2_GD_WV.pdf)
3.  [Lecture-4:pdf](http://www.cse.iitm.ac.in/~miteshk/CS7015/Slides/Handout/Lecture4.pdf) FFNs and Backprop 
4.  [Computational Graphs, Backprop:pdf](https://www.shane.st/teaching/574/spr24/slides/5_comp-graph.pdf)
5.  [Lecture](https://mitliagkas.github.io/ift6169-2022/ift-6169-lecture-10-notes.pdf) - Expressivity and UAT
6.  Neural Networks Review
...
When the constrains are removed, and $f_k(x)= {\bf x}{\bf w_k} + {\bf  b_k}$ is a linear model, we get a Vector Generalized Linear Model ([VGLM](https://en.wikipedia.org/wiki/Vector_generalized_linear_model)). VGLAM is shown as a (shallow) network below. ![Nueral Network with no hidden layers = VGLM](./../figs/FFNs-VGLMs.drawio.png){fig-align="center"}
...
$$ which is indeed an MLP with 1-hidden layer in hindsight, as illustrated in the figure below. ![SOP = MLP with 1-hidden layer](./../figs/FFNs-SOPs.drawio.png){fig-align="center"}
